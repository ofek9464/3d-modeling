...
1. **Composition**: use the requested balance; rule of thirds or centered symmetry are options.
...
| Unintended composition imbalance | Compare the framing with the brief; center or offset as appropriate |
